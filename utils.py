...
def train(config):
    ...
    if config['type'] == 'reinforce_with_baseline':
        ...
        for episode in range(config['max_episodes']):
            ...
            for step in range(config['max_steps']):
                ...
                if done:
                    ...
                    write_custom_scalar_to_tensorboard(summary_writer, 'avg_reward', average_rewards, episode)
                    write_custom_scalar_to_tensorboard(summary_writer, 'steps', step, episode)
                    break
            ...
            if config['type'] == 'reinforce':
                ...
                update_reinforce_with_baseline(sess, config, policy, baseline, episode_transitions)
